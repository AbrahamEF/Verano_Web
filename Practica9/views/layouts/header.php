<?php 
  define('BASEURL','http:localhost/Verano_Web/proyecto2(Examen3)');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Opciones de Registro<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a lass="various" data-fancybox-type="iframe" role="button" href="../autor/autor.php">Autor</a></li>
